...
def storypart4():
	answer5 = raw_input("which way do you turn? ")
	if answer5 == "left":
...
def storypart3():
	...
	if answer4 == "look":
		...
		print """you step on a twig as you walk back and th bush stops shaking... you start to step away faster and turn around. You run away and run faster as you hear water. You found a river! but there is one slight problem... there are more bears there caching salmon. you take a sip of the water and walk down the river, away from the bears... you walk for about an hour and meet an intersection"""
	else:
		print "that was not an option, you die"
	return storypart4()
